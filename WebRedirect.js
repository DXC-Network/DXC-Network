...
require('dotenv').config(); /// nodejs http and env required to make this work (will involve ENVs WEB_HOST and WEB_SELECT)
...
module.exports={
  GetHOSTNAME(){ return (process.env.WEB_HOST || selectedSite); },
  GetLOCALPORT(){ return (process.env.PORT || selectedPort); }
}
